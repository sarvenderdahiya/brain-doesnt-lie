...
participant_name = 'p6' #change participant name here
...
# export parameter
#====================================   YOUR PATH GOES HERE   ==================================================
record_export_folder = '/Your Path/Project/datasets/p6' #change participant name here
...
#====================================   YOUR PATH GOES HERE   ==================================================
vid_url = '/Your Path/Project/Videos/2.mp4'
# record parameter
record_name = str(participant_name) + '_vid_2'
record_description = str(record_name) + '_record_for_vid_2'
